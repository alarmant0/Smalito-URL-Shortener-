/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 35e4192e638b1e82b733ac6926161271)
...
declare namespace Cloudflare {
	...
	interface Env {
		URLS: KVNamespace;
		BLOCKED_IPS: KVNamespace;
		STORAGE: R2Bucket;
		DB: D1Database;
		RATE_LIMITER: RateLimit;
		ASSETS: Fetcher;
		GOOGLE_CLIENT_ID: "965314062049-gu023p97ugacvn4sdvbsk8tisbr0a8r2.apps.googleusercontent.com";
		ADMIN_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "ADMIN_URL" | "TURNSTILE_SECRET" | "GOOGLE_OAUTH_SECRET">> {}
}
